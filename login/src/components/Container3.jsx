...
export default function Container3({setCurrentContainer}) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(`https://peticiona-8a3b4bb2-c0c7-4a4e-b616-bc105682467b.up.railway.app/api/peticao/${idd}`, {
                    method: 'POST',
        ...
        const timeoutId = setTimeout(fetchData, 2000); // fetch data after 2 seconds
...
`;
    ...
    return (
        <section className="container" style={{width: '82%', height: '100%'}}>
            {isFetching ? <SplashScreen/> :
                <div className="row-final" style={{display: 'flex'}}>
                    <div className="editor-final" style={{width: '100%', height: '100%'}}>
                        <Editor
